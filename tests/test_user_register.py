...
class TestUserRegister(BaseCase):
    ...
    # с помощью @parametrize необходимо проверить, что отсутствие любого параметра
    # не дает зарегистрировать пользователя
    ...
    def test_create_user_short_name(self):
        ...
        {'password': '123', 'username': 'a', 'firstName': '123', 'lastName': '123', 'email': 'a@rr.nu'})
